#After pre-processing the available data set, we fit a GLM on the learning data set. 
#Doing this, we are able to estimate the number of claims for the testing data set and to compute the in-sample as well as out-of-sample losses.

#Fitting a Poisson GLM for the number of claims on the learning data.
...
#Add the fitted values for all observations in the learning set to the learning data set.
learn$glm <- glm1$fitted.values

#Using the glm model fitted on the learning data to obtain predictions for the number of claims for the testing data. 
...
#Add the fitted mean values for all observations in the learning set to the learning data set.
learn$glm2 <- glm2$fitted.values

#Using the glm model fitted on the learning data to obtain predictionsfor the number of claims for the testing data. 
#We add these predictions to the testing data. 
