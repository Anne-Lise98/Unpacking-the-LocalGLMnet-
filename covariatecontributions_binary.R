#This function plots the covariate contributions for the binary covariates for a LocalGLMnet. 
...
covariatecontributions_binary <- function(kk){
  dat_plt <- data.frame(var = factor(test_smp[, col_names[kk]]),
